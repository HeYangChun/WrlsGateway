...
typedef enum
{
  GPIO_MODE_IN_FL_NO_IT      = 0x00, // 0000 0000,  /*!< Input floating, no external interrupt */
  GPIO_MODE_IN_PU_NO_IT      = 0x40, // 0100 0000,  /*!< Input pull-up, no external interrupt */
  GPIO_MODE_IN_FL_IT         = 0x20, // 0010 0000,  /*!< Input floating, external interrupt */
  GPIO_MODE_IN_PU_IT         = 0x60, // 0110 0000,  /*!< Input pull-up, external interrupt */
  GPIO_MODE_OUT_OD_LOW_FAST  = 0xA0, // 1010 0000,  /*!< Output open-drain, low level, 10MHz */
  GPIO_MODE_OUT_PP_LOW_FAST  = 0xE0, // 1110 0000,  /*!< Output push-pull, low level, 10MHz */
  GPIO_MODE_OUT_OD_LOW_SLOW  = 0x80, // 1000 0000,  /*!< Output open-drain, low level, 2MHz */
  GPIO_MODE_OUT_PP_LOW_SLOW  = 0xC0, // 1100 0000,  /*!< Output push-pull, low level, 2MHz */
  GPIO_MODE_OUT_OD_HIZ_FAST  = 0xD0, // 1011 0000,  /*!< Output open-drain, high-impedance level,10MHz */
  GPIO_MODE_OUT_PP_HIGH_FAST = 0xF0, // 1111 0000,  /*!< Output push-pull, high level, 10MHz */
  GPIO_MODE_OUT_OD_HIZ_SLOW  = 0x90, // 1001 0000,  /*!< Output open-drain, high-impedance level, 2MHz */
  GPIO_MODE_OUT_PP_HIGH_SLOW = 0xD0, // 1101 0000   /*!< Output push-pull, high level, 2MHz */
}GPIO_Mode_TypeDef;
